...
public class CupboardDAOTest {
   @Autowired
   protected CupboardDAO cupboardDAO;

   public CupboardDAOTest() {
      try {
   ...
   public void testGetNeedById() throws IOException {
      Need need1 = new Need(1, "testname", 100.0, 5, "testtype");
      this.cupboardDAO.addNeed(need1);
   ...
   @Test
   public void testAddandDeleteNeed() throws IOException {
      ...
      boolean isdeleted = this.cupboardDAO.deleteNeed(reponseNeed.getId());
      Assertions.assertTrue(isdeleted);
      isdeleted = this.cupboardDAO.deleteNeed(reponseNeed.getId());
